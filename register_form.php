...
<br><br><button type="button"><a href="er.png">
    ...
    <button type="button"><a href="https://github.com/rattanachart/lab07/blob/master/dopost.php">
		Source code : dopost.php
	</a></button>
    <button type="button"><a href="https://github.com/rattanachart/lab07/blob/master/register_form.php">
		Source code : register_form.php
	</a></button>
    <button type="button"><a href="https://github.com/rattanachart/lab07/blob/master/show_register.php">
